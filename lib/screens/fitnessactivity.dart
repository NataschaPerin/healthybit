...
import 'package:healthybit/upper_body_workout.dart';

class FitnessActivityPage extends StatelessWidget {
  FitnessActivityPage({Key? key}) : super(key: key);

  static const route = '/Fitnesspage/';
  static const routename = 'Fitnesspage';

  final today = DateTime.now();

  @override
  Widget build(BuildContext context) {
    print('${FitnessActivityPage.routename} built');
    return Scaffold(
